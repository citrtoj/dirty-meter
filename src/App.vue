...
export default {
  ...
  methods:{
    ...
    mobileSongs(){
      ...
      {
        if(this.boolLyrics==true) {this.boolResults=false;}
      }
    },
    errorHandle(){
      this.percentage=-1;
    ...
    setLyrics(lyrics, title,artist){
      ...
      if(lyrics.lyrics === undefined) {this.errorHandle() ; return;}
    ...
    //when you like when you when when you
    //when you search song
